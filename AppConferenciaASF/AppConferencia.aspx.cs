...
namespace AppConferenciaASF
{
    public partial class AppConferencia : System.Web.UI.Page
    {
        ...
        protected int TotalDeLinhasConferencia(long numped)
        {
            ...
            {
                cnn.Open();
                OracleCommand cmd = new OracleCommand("SELECT I.* FROM PCPEDI I, PCPRODUT P, PCEMBALAGEM E WHERE I.CODPROD = P.CODPROD AND E.CODPROD = P.CODPROD AND I.CODFILIALRETIRA = 6 " +
                    "  AND E.CODFILIAL = 6 AND(I.QT / E.QTUNIT) <> NVL(I.QTSEPARADA, 0) AND I.NUMPED =: numped ORDER BY 2 ASC", cnn);
